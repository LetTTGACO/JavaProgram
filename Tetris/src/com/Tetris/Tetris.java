...
public class Tetris extends JPanel{
	...
	static {
		try {
			Z = ImageIO.read(Tetris.class.getResource("Z.jpg"));
			S = ImageIO.read(Tetris.class.getResource("S.jpg"));
			J = ImageIO.read(Tetris.class.getResource("J.jpg"));
			T = ImageIO.read(Tetris.class.getResource("T.jpg"));
			O = ImageIO.read(Tetris.class.getResource("O.jpg"));
			I = ImageIO.read(Tetris.class.getResource("I.png"));
			L = ImageIO.read(Tetris.class.getResource("L.jpg"));
